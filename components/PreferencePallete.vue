<template lang='pug'>
  div(class='flex flex-row flex-wrap items-center justify-center mt-4')
    div(class='preferences w-1/5 p-2 m-1 group hover:text-blue-light' v-for='preference in availablePreferences' :key='preference.name' @click='togglePreference($event, preference.name)')
      div(class='group-hover:text-blue-light pointer-events-none')
